 ...
 */
public class ActivityMensagemHandler extends Activity implements OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //this.getIntent().getIntExtra("id",value);
    ...
    private class Manipulador extends Handler {
        ...
        public void onSignupSuccess(UserModel userProfile) {
            ...
            _updateButton.setFocusable(true);
            _updateButton.setClickable(true);
